...
export class AccountService {
	...
	async findAccountByAddress(address: Address): Promise<AccountEntity> {
		...
		return await this.accountRepository
			...
			.leftJoinAndSelect('createdProjects.stems', 'createdProjectStems')
			.leftJoinAndSelect('createdProjects.collaborators', 'projectCollaborators')
			.leftJoinAndSelect('collaboratedProjects.stems', 'collaboratedProjectStems')
			.leftJoinAndSelect('collaboratedProjects.collaborators', 'collaboratorCollaborators')
