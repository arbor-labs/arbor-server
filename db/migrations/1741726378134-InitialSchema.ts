...
export class InitialSchema1741726378134 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "queued_stems" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "votes" integer NOT NULL, "queueId" character varying, "stemId" character varying, CONSTRAINT "UQ_3102ebccd0c072d88b4fc84854f" UNIQUE ("id"), CONSTRAINT "PK_3102ebccd0c072d88b4fc84854f" PRIMARY KEY ("id"))`);
